...
public class TypeTemplateServiceImpl implements TypeTemplateService {
    ...
    @Autowired
    private TbTypeTemplateMapper typeTemplateMapper;   //模板
    @Autowired
    private TbSpecificationOptionMapper specificationOptionMapper; //规格规格选项
    @Autowired
    ...
    private void saveToRedis(){
        ...
        System.out.println("缓存品牌列表,和规格列表");
    }
}
